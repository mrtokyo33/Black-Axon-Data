...
import SubjectSidebar from '../Learn/SubjectSidebar';
          ...
          <div className="flex-1">
            <div className="mb-6">
              <h1 className="text-3xl font-orbitron text-white mb-4">
                <span className="text-yellow neon-glow">{translations.practice.title}</span> - {translations.learn.subjects[activeSubject]}
              </h1>
            ...
            {/* Practice Content */}
            <PracticeContent subject={activeSubject} searchTerm={searchTerm} />
